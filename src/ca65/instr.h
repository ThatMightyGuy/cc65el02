...
*/
#define AM65_IMPLICIT           0x000000003UL /* IMP */
#define AM65_ACCU               0x000000002UL /* A */
#define AM65_DIR                0x000000004UL /* ZP */
#define AM65_ABS                0x000000008UL /* ABS */
#define AM65_ABS_LONG           0x000000010UL /* adr */
#define AM65_DIR_X              0x000000020UL /* ZP,X */
#define AM65_ABS_X              0x000000040UL /* ABS, X */
#define AM65_ABS_LONG_X         0x000000080UL /* adr,x */
#define AM65_DIR_Y              0x000000100UL /* ZP, Y */
#define AM65_ABS_Y              0x000000200UL /* ABS, Y */
#define AM65_DIR_IND            0x000000400UL /* (ZP) or (ZP),z (4510 / 45GS02) */
#define AM65_ABS_IND            0x000000800UL /* (ABS) */
#define AM65_DIR_IND_LONG       0x000001000UL /* [ABS] (65816) */
#define AM65_DIR_IND_Y          0x000002000UL /* (ZP),y */
#define AM65_DIR_IND_LONG_Y     0x000004000UL /* [adr],y (not 45GS02) */
#define AM65_DIR_X_IND          0x000008000UL /* (ZP,x) */
#define AM65_ABS_X_IND          0x000010000UL /* (ABS,x) */
#define AM65_REL                0x000020000UL /* REL */
#define AM65_REL_LONG           0x000040000UL /* LONGREL */
#define AM65_STACK_REL          0x000080000UL /* adr,s */
#define AM65_STACK_REL_IND_Y    0x000100000UL /* (rel,s),y */
#define AM65_IMM_ACCU           0x000200000UL
#define AM65_IMM_INDEX          0x000400000UL
#define AM65_IMM_IMPLICIT       0x000800000UL /* IMM */
#define AM65_BLOCKMOVE          0x001000000UL
#define AM65_BLOCKXFER          0x002000000UL
#define AM65_ABS_IND_LONG       0x004000000UL /* (adr) [dir] */
#define AM65_IMM_IMPLICIT_WORD  0x008000000UL /* PHW #$1234 (4510 only) */
#define AM65_ZP_REL             0x010000000UL /* ZP, REL (m740) */
#define AM65_SPECIAL_PAGE       0x020000000UL /* $FFxx (m740) */
#define AM65_32BIT_BASE_IND_Z   0x040000000UL /* LDA [$nn],Z (45GS02 only) */
#define AM65_Q                  0x080000000UL /* Q (45GS02 only) */
/* R-stack addressing modes */
// TODO: Determine if they're needed
#define AM65_R_STACK_REL        0x100000000UL /* adr,r (65el02 only) */
#define AM65_R_STACK_REL_IND_Y  0x200000000UL /* (rel,r),y (65el02 only) */
...
#define AM65I_Q                  31
#define AM65I_R_STACK_REL        32
#define AM65I_R_STACK_REL_IND_Y  33
#define AM65I_COUNT              34
